...
const capasClusterData = [
    ...
    { url:"data/bomberos.geojson", nombre:"Estaciones de Bomberos", grupo:"Servicios", campos:{ "PARQUE":{nombre:"Nombre"}, "DIRECCION":{nombre:"Dirección / Adresse"} }, titulo:"Parque de bomberos", icon:"icons/bomberos.svg" },
